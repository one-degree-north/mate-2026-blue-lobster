...
class MultiCrabTracker:
    def __init__(
        self, min_present=8, distance_thresh=120, missing_frames=25, recount_cooldown=60, detection_interval=3
    ):
    ...
    def load_training_image(self, url):
        ...
        self.training_images.append({"gray": gray, "kp": kp, "des": des, "color": color})
    ...
    def draw(self, frame):
        ...
        cv2.putText(frame, f"Crabs counted: {self.counter}", (20, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 3)

        cv2.putText(frame, "SPACE = Start/Stop Counting", (20, 90), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)

        cv2.putText(frame, "Q = Quit", (20, 120), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
